...
<head>
    <title>Xerador de preguntas XML para Moodle - Galego</title>
    <meta charset=utf-8>
    ...
    <script src=js/lang_pt.js></script>
...
<body>
    <nav>
        ...
        <select name="idioma" onchange="location = this.value;" class=form-group-idioma data-width=150px>
            ...
            <option value="../cat/" data-content='<span class="flag-icon catalonia"></span> Catalá'>Catalá</option>
            <option value="#" data-content='<span class="flag-icon flag-icon-pt"></span> Portugues' selected>Portugues</option>
    ...
    <div id=app class=container>
        ...
        <p><br><br><br>
            <center><small><a href='https://youtu.be/7f3lV9bp2Lk'>Instruções para importar o ficheiro para o Moodle</a>.
                    <br>Baseado en <a href="https://github.com/mbolis/moodle-quiz-builder" target="_blank">"moodle-quiz-builder"</a>" de Marco Bolis.
                    <br>Traducido por <b>Jose Pazó</b> e modificado por <b>Francisco Alonso</b>.
                    <br><a href="http://www.edu.xunta.gal/centros/ceipabanqueiro/">CEIP Plurilingüe de Abanqueiro</a>
                    <br><b>ver.1.4</b> - 14/12/2020</small><br>&nbsp;<br><img src="https://i.creativecommons.org/l/by-nc/3.0/88x31.png" alt="by-nc" border="0"></center>
        </p>
    </div>
